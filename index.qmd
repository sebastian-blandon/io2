...
<img src="0_Figures/0_Mesas_Sillas.png" style="max-height: 42vh; width: auto; display: block; margin: auto;">
Adaptado de GEIO
...
$$
\begin{align*}
\text{max } Z(X_1,X_2) &= 16X_{1} + 13X_{2}\\ 
\\
\text{s.a:} \\
X_{1} + 2X_{2} &\leq 17 \quad \text{(Fichas máximas de 8 pines)} \\
3X_{1} + 2X_{2} &\leq 18  \quad \text{(Fichas máximas de 4 pines)} \\
X_{1}, X_{2} &\geq 0 \quad \text{(No negatividad)} \\
\\
\text{Donde:} \\
...
![](0_Figures/0_OptimizationSoftware.png)
